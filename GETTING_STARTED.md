...
| 7    | (Opcional) Sincronizar el vault con git (al guardar o cada X min) | Daemon Go [`cmd/obsidian-memoryd/`](./cmd/obsidian-memoryd/) o tarea Windows: [`docs/setup/windows-scheduled-vault-sync.md`](./docs/setup/windows-scheduled-vault-sync.md) |
