...
node packages/create-obsidian-memory/src/index.js --non-interactive --vault "/ruta/absoluta/al/vault" --with-hybrid --repo-root "/ruta/absoluta/al/cursor-obsidian-memory-guide"
```
