...
- **`docs/setup/memory-repo-sin-automatismos-locales.md`** / **`.en.md`**: memoria del agente colocada en el mismo clon git que ya actualizas con `git pull`/`git push` — sin `.bat`/`.ps1`/Programador de tareas en tu PC.
