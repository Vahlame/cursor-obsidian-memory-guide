...
| 7    | (**Optional**) Git sync (on save or on a timer)            | Go daemon [`cmd/obsidian-memoryd/`](./cmd/obsidian-memoryd/), Windows task: [`docs/setup/windows-scheduled-vault-sync.en.md`](./docs/setup/windows-scheduled-vault-sync.en.md), **MCP always on:** [`docs/setup/windows-basic-memory-always-on.en.md`](./docs/setup/windows-basic-memory-always-on.en.md) |
